...
namespace MefistoTheatreCompany.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
            //gets the details of the user that is logged in
            var user = UserManager.Users.Where(u => u.Email.Equals(User.Identity.Name)).First();

            if (user != null)
            {
                //takes the  details of the user and displays them
        ...
        {
            //gets the details of the user that is logged in
            var user = UserManager.Users.Where(u => u.Id.Equals(model.UserId)).First();

            if (user != null)
            {
                //gets the new details updated by the user and updates the database
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("Index"); // Modify as needed
                }
            }
