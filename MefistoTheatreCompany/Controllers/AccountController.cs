    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
           // if (!ModelState.IsValid)
            //{
                //    //if(model.Password != UserManager.Users(id).)
                //    return View(model);
                //var prevusername = model.Email;
                ///if new username is equal to model.email set
           ...
           // }
            ...
            var result = await SignInManager.PasswordSignInAsync(model.Email, model.Password, model.RememberMe=true, shouldLockout: true);
            switch (result)
            {
        ...
        {
            // Require that the user has already logged in via username/password or external loginyjh,
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
               ...
               
                {
                    ...
                    //record the date and time when the user is registered
